...
RSpec.describe FavoritelistsController, type: :controller do
  ...
  # FavoritelistsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Favoritelist" do
        expect {
          post :create, params: {favoritelist: valid_attributes}, session: valid_session
        }.to change(Favoritelist, :count).by(1)
      end

      it "redirects to the created favoritelist" do
        post :create, params: {favoritelist: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Favoritelist.last)
      end
    end

    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {favoritelist: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
