...
ActiveRecord::Schema.define(version: 2019_01_28_224030) do
  ...
  create_table "favoritelists", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_favoritelists_on_user_id"
  end

  create_table "favoritelists_products", id: false, force: :cascade do |t|
